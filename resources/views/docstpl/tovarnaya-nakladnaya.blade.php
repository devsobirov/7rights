        ...
        <form method = "POST" class = "docForm" action="{{ route('docs.open', $doc_id) }}">
            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col">
                        <label for="sch-number">№ Договора</label>
                        <input type="text" class="form-control" placeholder="20016101" name = "sch_number" value="{{ get_if_key_exists($data, 'sch_number') }}" id="sch-number">
                    </div>
                    <div class="col">
                ...
                <div class="form-group row">
                    <label for="sch-nazn" class="col-sm-2 col-form-label">Основание</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="sch-nazn" placeholder="Заказ #20016101 от 21.06.2022" name = "sch_nazn" value="{{ get_if_key_exists($data, 'sch_nazn') }}">
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col">
                        @include('edit.org_info2')
